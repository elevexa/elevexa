...
const Section7 = () => {
  ...
  return (
    <section
      ref={ref}
      className="max-w-[1376px] mx-auto mt-[60px] sm:mt-[180px] px-[16px] sm:px-6 lg:px-8 text-center"
      id='pricing'
    >
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-[16px] md:mt-[45px]">
        ...
        <div className="bg-white p-[45px] rounded-lg text-left text-[#191919]">
          ...
          <p className="font-commissioner mt-[5px]">
            <span className="text-[28px] leading-[30px] font-medium">
        ...
        <div className="bg-white p-8 rounded-lg text-left text-[#191919]">
          ...
          <p className="font-commissioner mt-[5px]">
            <span className="text-[28px] leading-[30px] font-medium mt-[5px]">35%</span>
          </p>
          <a
            href="https://calendly.com/dbujor-elevexa/30min"
            target="_blank"
        ...
        <div className="bg-white p-8 rounded-lg text-left text-[#191919]">
          ...
          <p className="font-commissioner mt-[5px]">
            <span className="text-[28px] leading-[30px] font-medium mt-[5px]">Contact sales</span>
          </p>
          <a
            href="https://calendly.com/dbujor-elevexa/30min"
            target="_blank"
