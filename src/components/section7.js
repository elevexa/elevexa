  ...
  return (
    ...
    >
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-[16px] md:mt-[45px]">
        {/* The Quick Fix */}
        <div className="bg-[#F2F2F2] p-[45px] mt-[30px] sm:mt-0 rounded-lg text-left text-[#191919]">
        ...
        {/* The Open Book */}
        <div className="p-[45px] rounded-lg text-left text-[#191919] bg-[#F2F2F2]">
