const Section1 = () => {
    return (
      <section className="max-w-[1376px] mx-auto flex flex-col-reverse md:flex-row items-center md:items-start justify-between px-[16px] md:mt-[45px] md:px-8">
        ...
        <div className="md:w-1/2">
          <img src="/gif/1.gif" alt="Developer at work" className="w-full rounded-lg shadow-md" />
        </div>
      </section>
    );
  };
