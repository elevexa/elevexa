...
const Section8 = () => {
  ...
  return (
    <section
      ref={ref}
      className="max-w-[1376px] mx-auto px-[16px] mt-[60px] sm:mt-[180px] sm:px-6 lg:px-8 flex flex-col-reverse lg:flex-row items-center lg:items-start text-left"
    >
      <div className="lg:w-1/2 lg:pr-[16px] text-[#191919]">
        <h2 className="md:text-[62px] md:leading-[62px] text-[36px] leading-[36px] mt-[30px] md:mt-0 font-youngSerif">
