  ...
  return (
    <section className="max-w-[1376px] mx-auto px-[16px] mt-[60px] sm:mt-[180px] sm:px-6 lg:px-8 flex flex-col-reverse lg:flex-row items-center lg:items-start text-left">
      <div className="lg:w-1/2 lg:pr-[16px]">
        ...
        <p className="text-[18px] md:text-[24px] leading-[24px] md:leading-[32px] mt-[30px] text-[#191919] font-commissioner">
        ...
        <p className="text-[18px] md:text-[24px] leading-[24px] md:leading-[32px] mt-[30px] font-commissioner text-[#191919">
